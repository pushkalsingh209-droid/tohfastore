      ...
      <div className="flex-grow py-12 md:py-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-faint text-sm font-light mt-3 max-w-xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10 text-center">
            {[
              ...
              <div key={item.label} className="bg-surface border border-border rounded-lg p-4">
                <p className="text-xs font-serif font-semibold text-link mb-1">{item.label}</p>
          ...
          {sent ? (
            <div className="bg-surface border border-border rounded-lg p-6 sm:p-10 shadow-sm text-center space-y-3 max-w-md mx-auto">
              ...
              <p className="text-sm text-muted font-medium">Thanks &mdash; we&rsquo;ve received your inquiry and will reach out shortly.</p>
              <a
            ...
            <form onSubmit={handleSubmit} className="bg-surface border border-border rounded-lg p-6 sm:p-8 shadow-sm space-y-4 max-w-xl mx-auto">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider text-muted font-semibold mb-2">
                    Company <span className="normal-case text-faint">(optional)</span>
                  </label>
                  <input
                    type="text"
                    value={company}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider text-muted font-semibold mb-2">Phone / WhatsApp</label>
                  <input
                    type="tel"
                    value={phone}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs uppercase tracking-wider text-muted font-semibold mb-2">
                    Approx. Quantity <span className="normal-case text-faint">(optional)</span>
                  </label>
                  <input
                    type="text"
                    value={quantity}
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider text-muted font-semibold mb-2">
                    Occasion <span className="normal-case text-faint">(optional)</span>
                  </label>
                  <input
                    type="text"
                    value={occasion}
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider text-muted font-semibold mb-2">
                  Tell us more <span className="normal-case text-faint">(optional)</span>
                </label>
                <textarea
                  rows={3}
                  value={message}
