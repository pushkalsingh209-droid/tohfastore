...
describe.skipIf(!configured)("RLS perimeter (anon key)", () => {
  ...
  it("is intact: anon can't read orders/coupons/leads/site_settings/orders_cancelled_archive/hidden products/unapproved reviews, can read visible products, can't write", async () => {
