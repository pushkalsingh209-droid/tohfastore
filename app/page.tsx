// app/page.tsx
"use client"; // Crucial: This unlocks frontend interactivity and click listeners

import { useState, useEffect } from "react";
import { createClient } from "@supabase/supabase-js";
import { useCart } from "@/app/context/CartContext";

// Initialize Supabase Client directly using your public keys
...
export default function StorefrontHome() {
  ...
  // Connect the global shopping cart click-action hooks
  const { addToCart } = useCart();

  // Fetch product inventory arrays from Supabase on page mount
  useEffect(() => {
  ...
  return (
    <div className="pb-16 bg-[#FAF9F6] min-h-screen">
              ...
              <div key={product.id} className="bg-white border border-stone-200 rounded-lg overflow-hidden group shadow-sm hover:shadow-md transition duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-stone-100">
                    ...
                    {/* Active operational push-action link */}
                    <button 
