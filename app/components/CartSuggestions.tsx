          ...
          return (
            <div key={product.id} className="flex-shrink-0 w-24">
              ...
              <button
                ...
                disabled={added}
                className="mt-1 w-full text-[9.5px] uppercase tracking-wider font-semibold py-1.5 rounded border border-border-strong text-muted hover:bg-surface-2 disabled:opacity-50 disabled:cursor-default transition"
              >
                {added ? "Added" : "+ Add"}
              </button>
            </div>
