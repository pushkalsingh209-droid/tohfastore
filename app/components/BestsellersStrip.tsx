...
// second product grid.
export default function BestsellersStrip({ items }: { items: BestsellerItem[] }) {
  if (items.length === 0) return null;

  return (
    <section className="max-w-7xl mx-auto px-6 pt-14">
      <h2 className="text-xl font-serif text-stone-900 dark:text-stone-100 mb-5">Bestsellers</h2>
