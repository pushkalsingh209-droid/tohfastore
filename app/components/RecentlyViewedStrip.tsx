...
export default function RecentlyViewedStrip({ excludeId }: { excludeId?: string | number }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 pb-16">
      <h2 className="text-lg font-serif text-fg border-b border-border pb-3 mb-6">
        Recently Viewed
      </h2>
      <div className="flex gap-4 overflow-x-auto pb-2 -mx-6 px-6 sm:mx-0 sm:px-0">
        {items.map((product) => (
          ...
          >
            <div className="relative w-32 h-32 sm:w-36 sm:h-36 rounded-lg overflow-hidden border border-border bg-white">
