...
export default function StickyAddToCartBar({ product }: { product: any }) {
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-white dark:bg-stone-900 border-t border-stone-200 dark:border-stone-800 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] p-3 flex items-center gap-3 print:hidden">
