        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3 p-4 sm:p-5 border-b border-border">
              <h3 className="text-base font-serif font-bold text-fg">Create an Instagram reel</h3>
              <button type="button" onClick={handleClose} aria-label="Close" className="text-faint hover:text-muted text-xl leading-none">
                &times;
              </button>
            </div>
            ...
            <div className="p-4 sm:p-5 space-y-4">
              <div
                className="relative w-full mx-auto rounded-lg border border-border overflow-hidden bg-surface-2"
              ...
              <div>
                <label htmlFor="tohfa-reel-caption" className="block text-[11px] uppercase tracking-wider font-semibold text-faint mb-1">
            ...
            <div className="flex gap-2 p-4 sm:p-5 border-t border-border sticky bottom-0 bg-surface">
              ...
              {videoUrl ? (
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded bg-fg text-bg hover:bg-accent hover:text-accent-fg text-sm font-semibold transition text-center disabled:opacity-50"
                >
            ...
            {videoUrl && (
              <div className="px-4 sm:px-5 pb-4 sm:pb-5 -mt-2">
                <button
                  ...
                  className="w-full text-xs text-faint hover:text-muted underline"
                >
                  Record again
                </button>
              </div>
