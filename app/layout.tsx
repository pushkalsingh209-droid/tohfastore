    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <CatalogLoadingProvider>
        <body className="bg-bg text-fg antialiased min-h-screen flex flex-col transition-colors">
          ...
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:bg-accent focus:text-accent-fg focus:px-4 focus:py-2 focus:rounded focus:shadow-lg focus:text-sm focus:font-semibold"
          >
          ...
          <footer className="bg-footer-bg text-footer-fg py-12 border-t-4 border-accent">
            <div className="max-w-7xl mx-auto px-6 text-center text-sm">
              <p className="font-serif text-footer-accent text-lg mb-1 tracking-wider">Tohfa Premium Handicrafts</p>
              <p className="italic text-footer-accent/80 text-xs mb-3">Crafted Traditions. Timeless Gifts.</p>
              <p className="text-footer-fg text-xs font-light max-w-md mx-auto mb-4">
              ...
              <div className="flex items-center justify-center gap-4 mb-5">
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/10 hover:border-footer-accent text-footer-fg hover:text-footer-accent flex items-center justify-center transition"
                >
              ...
              <p className="text-footer-fg/70 text-[11px] uppercase tracking-wider font-light">
